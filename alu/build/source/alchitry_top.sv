...
module alchitry_top (
    ...
    localparam _MP_STAGES_870114318 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_870114318)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_CLK_FREQ_830532451 = 24'h989680;
    localparam _MP_MIN_DELAY_830532451 = 5'h14;
    localparam _MP_NUM_SYNC_830532451 = 2'h2;
    logic M_button_cond_in;
    logic M_button_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_830532451),
        .MIN_DELAY(_MP_MIN_DELAY_830532451),
        .NUM_SYNC(_MP_NUM_SYNC_830532451)
    ) button_cond (
        .clk(clk),
        .in(M_button_cond_in),
    ...
    localparam _MP_RISE_1514651981 = 1'h1;
    localparam _MP_FALL_1514651981 = 1'h0;
    logic M_edge_in;
    logic M_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1514651981),
        .FALL(_MP_FALL_1514651981)
    ) L_edge (
        .clk(clk),
        .in(M_edge_in),
        .out(M_edge_out)
    ...
    localparam _MP_CLK_FREQ_906689760 = 24'h989680;
    ...
    alu_manual_tester #(
        .CLK_FREQ(_MP_CLK_FREQ_906689760)
    ) alu_manual (
        .io_button(io_button),
        .io_dip(io_dip),
        .clk(clk),
