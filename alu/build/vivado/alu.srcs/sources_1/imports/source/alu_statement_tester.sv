...
module alu_statement_tester #(
    ...
    localparam _MP_RISE_1361991976 = 1'h1;
    localparam _MP_FALL_1361991976 = 1'h0;
    logic M_slow_clock_edge_in;
    logic M_slow_clock_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1361991976),
        .FALL(_MP_FALL_1361991976)
    ) slow_clock_edge (
        .clk(clk),
    ...
    localparam _MP_SIZE_238585416 = 1'h1;
    localparam _MP_DIV_238585416 = 5'h18;
    localparam _MP_TOP_238585416 = 1'h0;
    localparam _MP_UP_238585416 = 1'h1;
    logic [0:0] M_slow_clock_value;
    
    counter #(
        .SIZE(_MP_SIZE_238585416),
        .DIV(_MP_DIV_238585416),
        .TOP(_MP_TOP_238585416),
        .UP(_MP_UP_238585416)
    ) slow_clock (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1774009460 = 3'h4;
    localparam _MP_DIV_1774009460 = 5'h10;
    logic [3:0][3:0] M_seg_display_values;
    logic [6:0] M_seg_display_seg;
    logic [3:0] M_seg_display_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1774009460),
        .DIV(_MP_DIV_1774009460)
    ) seg_display (
        .clk(clk),
        .rst(rst),
