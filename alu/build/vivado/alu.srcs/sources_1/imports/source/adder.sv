...
module adder #(
    ...
    localparam _MP_SIZE_1438197390 = SIZE;
    logic [(_MP_SIZE_1438197390)-1:0] M_rca_a;
    logic [(_MP_SIZE_1438197390)-1:0] M_rca_b;
    logic M_rca_cin;
    logic M_rca_cout;
    logic [(_MP_SIZE_1438197390)-1:0] M_rca_s;
    
    rca #(
        .SIZE(_MP_SIZE_1438197390)
    ) rca (
        .a(M_rca_a),
        .b(M_rca_b),
        .cin(M_rca_cin),
